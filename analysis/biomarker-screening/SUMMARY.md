...
| C3 | Institute funding over time | Top 5 institutes as trend lines, remaining as shaded band | `institute_over_time.png` |
| C4 | Clinical vs research over time | How clinical and research biomarker funding changed year by year | `category_over_time.png` |
| C5 | Core terms: clinical vs research | Each core biomarker term's funding split by clinical vs research | `core_terms_by_mechanism.png` |
| C6 | Expanded terms: clinical vs research | Expanded terms split by clinical vs research | `expanded_terms_by_mechanism.png` |
...
The top 5 institutes by total biomarker funding are shown as trend lines, with
the remaining institutes collapsed into a shaded band. Each institute uses a
consistent color across all charts in this document.

### C4: Clinical vs Research Over Time

![Clinical vs research over time](charts/category_over_time.png)

Grants are classified as "Clinical" if NIH tagged them with Clinical Research,
Clinical Trials, or Clinical Trials and Supportive Activities in their spending
categories. All other grants are classified as "Research." The vermillion
(Clinical) and blue (Research) colors are used consistently in charts C4, C5,
and C6.

### C5: Core Biomarker Terms — Clinical vs Research

![Core terms: clinical vs research](charts/core_terms_by_mechanism.png)

Each of the 13 core biomarker terms is shown with two bars: blue for
research funding and vermillion for clinical funding. Terms below $1 billion
total are collapsed into an "Other" bucket. A single grant can match multiple
terms, so the rows are not mutually exclusive.

### C6: Expanded Terms — Clinical vs Research

![Expanded terms: clinical vs research](charts/expanded_terms_by_mechanism.png)

The expanded keyword set adds 23 broader terms beyond the 13 core terms.
Terms below $1 billion total are collapsed into an "Other" bucket. The two
largest expanded terms capture grants where "clinical" co-occurs with "omics"
or "imaging" in the grant record — these co-occurrence terms identify grants
at the intersection of clinical work and molecular or imaging methodologies.
