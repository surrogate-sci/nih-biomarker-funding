...
class TestContainsBiomarkerTerms(unittest.TestCase):
    def test_simple_match(self):
        ...
        self.assertTrue(
            contains_biomarker_terms("This is a biomarker study", ["biomarker"])
        )
    ...
    def test_no_match(self):
        ...
        self.assertFalse(
            contains_biomarker_terms("This is a cancer study", ["biomarker"])
        )
    ...
    def test_and_condition_match(self):
        ...
        self.assertTrue(
            contains_biomarker_terms("clinical omics study", ["clinical+omics"])
        )
...
class TestPrimaryTerm(unittest.TestCase):
    def test_specific_wins_over_generic(self):
        ...
        self.assertEqual(
            primary_term(["biomarker", "surrogate endpoint"]), "surrogate endpoint"
        )
    ...
    def test_imaging_marker_over_biomarker(self):
        ...
        self.assertEqual(
            primary_term(["biomarker", "imaging marker"]), "imaging marker"
        )
    ...
    def test_clinical_omics_over_biomarker(self):
        ...
        self.assertEqual(
            primary_term(["biomarker", "clinical+omics"]), "clinical+omics"
        )
