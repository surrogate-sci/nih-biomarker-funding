# README Archive (March 2026)

> Archived on 2026-04-01. This was the project README prior to documentation
> reorganization. It describes the original script-by-script workflow including
> scripts that have since been superseded by Inspect AI.
